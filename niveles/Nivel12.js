...
/********************************************************************************/
    ...
    listaDeEspinas[0].anchor.setTo(0.5, 0.5);
    listaDeEspinas[0].angle = 90;
    CrearEspinas(300,400);
    listaDeEspinas[1].anchor.setTo(0.5, 0.5);
    listaDeEspinas[1].angle = 90;
    CrearEspinas(400,440);
    listaDeEspinas[2].anchor.setTo(0.5, 0.5);
    listaDeEspinas[2].angle = 90;
    CrearEspinas(500,480);
    listaDeEspinas[3].anchor.setTo(0.5, 0.5);
    listaDeEspinas[3].angle = 90;
    CrearEspinas(600,520);
    listaDeEspinas[4].anchor.setTo(0.5, 0.5);
    listaDeEspinas[4].angle = 90;
    tutorial();
